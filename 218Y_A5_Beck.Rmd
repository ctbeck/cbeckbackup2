...
Moving on to our equity analysis in part 2, we were looking at how race and income could affect the distribution of good/moderate air quality. For the race analysis, it did seem fairly representational of the racial breakdown of the region, and also quite even across moderate and good. This may just be because the AQI of the region is already pretty good. For income too, the population was equitably distributed between good and moderate. For both of these, the majority is white people with over $150,000. If we were to look specifically at East Palo Alto, or other less affluent jurisdictions, that might not be the case. But since this chart is representing all of San Mateo County's data, we are probably seeing skewed data towards a more rosy picture. This would be an interesting area for follow up study. 
