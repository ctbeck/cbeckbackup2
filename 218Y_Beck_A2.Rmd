...
Narrowing down to East Oakland block groups, which has the highest percentage of BIPOC and working class tracts which are traditionally further from amenities.  <br> 
```{r}
